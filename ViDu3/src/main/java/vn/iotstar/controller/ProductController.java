...
public class ProductController {
    ...
    private final vn.iotstar.repository.CategoryRepository categoryRepository;

    public ProductController(ProductService productService, vn.iotstar.repository.CategoryRepository categoryRepository) {
